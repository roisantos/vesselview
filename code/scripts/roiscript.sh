#!/bin/bash
#SBATCH -J roinetac        # Nombre del trabajo
#SBATCH -o roinetac_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e roinelac_error_%j.log    # Archivo para la salida de errores
