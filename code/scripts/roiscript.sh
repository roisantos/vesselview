#!/bin/bash
#SBATCH -J R1133x10        # Nombre del trabajo
#SBATCH -o R1133x10_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e R1133x10_error_%j.log    # Archivo para la salida de errores
