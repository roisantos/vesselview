#!/bin/bash
#SBATCH -J R5x10c        # Nombre del trabajo
#SBATCH -o R5x10c_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e R5x10c_error_%j.log    # Archivo para la salida de errores
