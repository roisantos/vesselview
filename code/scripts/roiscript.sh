#!/bin/bash
#SBATCH -J R11x10        # Nombre del trabajo
#SBATCH -o R11x10_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e R11x10_error_%j.log    # Archivo para la salida de errores
