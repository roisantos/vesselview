#!/bin/bash
#SBATCH -J R3x10a        # Nombre del trabajo
#SBATCH -o R3x10a_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e R3x10a_error_%j.log    # Archivo para la salida de errores
