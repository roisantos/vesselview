#!/bin/bash
#SBATCH -J R3x10        # Nombre del trabajo
#SBATCH -o R3x10_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e R3x10_error_%j.log    # Archivo para la salida de errores
