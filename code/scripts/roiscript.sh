#!/bin/bash
#SBATCH -J 5bBigK_fives        # Nombre del trabajo
#SBATCH -o 5bBigK_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e 5bBigK_error_%j.log    # Archivo para la salida de errores
