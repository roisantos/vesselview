#!/bin/bash
#SBATCH -J R11x20a4        # Nombre del trabajo
#SBATCH -o R11x20a4_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e R11x20a4_error_%j.log    # Archivo para la salida de errores
