#!/bin/bash
#SBATCH -J R3x20        # Nombre del trabajo
#SBATCH -o R3x20_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e R3x20_error_%j.log    # Archivo para la salida de errores
