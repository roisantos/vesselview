#!/bin/bash
#SBATCH -J RoiB2x2        # Nombre del trabajo
#SBATCH -o RoiB2x2_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e RoiB2x2_error_%j.log    # Archivo para la salida de errores
