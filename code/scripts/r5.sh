#!/bin/bash
#SBATCH -J R5x10        # Nombre del trabajo
#SBATCH -o R5x10_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e R5x10_error_%j.log    # Archivo para la salida de errores
