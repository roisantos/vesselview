#!/bin/bash
#SBATCH -J T        # Nombre del trabajo
#SBATCH -o T_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e T_error_%j.log    # Archivo para la salida de errores
