#!/bin/bash
#SBATCH -J FR6        # Nombre del trabajo
#SBATCH -o FR6_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e FR6_error_%j.log    # Archivo para la salida de errores
