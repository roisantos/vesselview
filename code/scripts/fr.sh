#!/bin/bash
#SBATCH -J FR1-6        # Nombre del trabajo
#SBATCH -o FR1-6_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e FR1-6_error_%j.log    # Archivo para la salida de errores
