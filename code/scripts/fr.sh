#!/bin/bash
#SBATCH -J NoAcc        # Nombre del trabajo
#SBATCH -o NoAcc_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e NoAcc_error_%j.log    # Archivo para la salida de errores
