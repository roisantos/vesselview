#!/bin/bash
#SBATCH -J F7-664        # Nombre del trabajo
#SBATCH -o F7-664_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e F7-664_error_%j.log    # Archivo para la salida de errores
