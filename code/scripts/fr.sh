#!/bin/bash
#SBATCH -J F11-696        # Nombre del trabajo
#SBATCH -o F11-696_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e F11-696_error_%j.log    # Archivo para la salida de errores
