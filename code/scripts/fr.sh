#!/bin/bash
#SBATCH -J Ft5-664        # Nombre del trabajo
#SBATCH -o Ft5-664_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e Ft5-664_error_%j.log    # Archivo para la salida de errores
