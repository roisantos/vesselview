...
#SBATCH -o RoiNet9_FIVESc_FocalTverskyGamma1.5_gein_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e RoiNet9_FIVESc_FocalTverskyGamma1.5_gein_%j.log    # Archivo para la salida de errores
...
LOSS="FocalTversky"
LOGGING="True"
OUTPUT_PREFIX="RoiNet9_FIVESc_FocalTverskyGamma1.5_gein_"
THRESH_VALUE=100
