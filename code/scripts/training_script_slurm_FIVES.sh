#!/bin/bash
#SBATCH -J r9fa       # Nombre del trabajo
#SBATCH -o RoiNet9_FIVES_Dice_NewFAugmentation_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e RoiNet9_FIVES_Dice_NewFAugmentation_error_%j.log    # Archivo para la salida de errores
...
LOSS="Dice"
LOGGING="True"
OUTPUT_PREFIX="RoiNet9_FIVES_Dice_NewFAugmentation_"
THRESH_VALUE=100
