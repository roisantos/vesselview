#!/bin/bash
#SBATCH -J r9x15fa_c       # Nombre del trabajo
#SBATCH -o RoiNet9x1.5_FIVESc_Dice_NewFAugmentation_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e RoiNet9x1.5_FIVESc_Dice_NewFAugmentation_error_%j.log    # Archivo para la salida de errores
...
LOSS="Dice"
LOGGING="True"
OUTPUT_PREFIX="RoiNet9x1.5_FIVESc_Dice_NewFAugmentation_"
THRESH_VALUE=100
