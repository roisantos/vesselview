#!/bin/bash
#SBATCH -J r9x05fa_c       # Nombre del trabajo
#SBATCH -o RoiNet9x0.5_FIVESc_Dice_NewFAugmentation_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e RoiNet9x0.5_FIVESc_Dice_NewFAugmentation_error_%j.log    # Archivo para la salida de errores
