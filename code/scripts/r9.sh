#!/bin/bash
#SBATCH -J cR9x10a        # Nombre del trabajo
#SBATCH -o cR9x10a_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e cR9x10a_error_%j.log    # Archivo para la salida de errores
