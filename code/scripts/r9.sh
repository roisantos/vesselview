#!/bin/bash
#SBATCH -J R9x10a        # Nombre del trabajo
#SBATCH -o R9x10a_output_%j.log   # Archivo para la salida estándar (%j expande al JobID)
#SBATCH -e R9x10a_error_%j.log    # Archivo para la salida de errores
